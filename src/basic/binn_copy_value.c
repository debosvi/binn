...
///////////////////////////////////////////////////////////////////////////////
static int binn_copy_int_value(const void const *psource, void *pdest, const binn_type_t type, const unsigned int size) {
    int _ret=0;
    (void)size;
...
///////////////////////////////////////////////////////////////////////////////
static int binn_copy_float_value(const void const *psource, void *pdest, const binn_type_t type, const unsigned int size) {
    int _ret=0;
    (void)size;
...
///////////////////////////////////////////////////////////////////////////////
static int binn_copy_raw_value(const void const *psource, void *pdest, const binn_type_t type, const unsigned int size) {
    int _ret=0;
    (void)size;
...
///////////////////////////////////////////////////////////////////////////////
int binn_copy_value(const void const *psource, void *pdest, const binn_type_t type, const unsigned int size) {
    int _ret=0;
    ...
    switch(type) {
        ...
        case BINN_TYPE_INT64: 
            _ret=binn_copy_int_value(psource, pdest, type, size);
            break;
        
        case BINN_TYPE_FLOAT: 
        case BINN_TYPE_DOUBLE: 
            _ret=binn_copy_float_value(psource, pdest, type, size);
            break;

        case BINN_TYPE_BLOB: 
        case BINN_TYPE_STRING: 
            _ret=binn_copy_raw_value(psource, pdest, type, size);
            break;
